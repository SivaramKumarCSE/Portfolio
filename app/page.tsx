    ...
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
         ...
         HI ,I am Sivaram Kumar, with a fervent enthusiasm for coding and UI/UX design, I embark on a journey dedicated to shaping immersive digital experiences. Specializing in web development, I'm here to transform visions into reality."
          </p>
